...
int main(int argc, char **argv) {
    ...
    train_outs.push_back(fc8->f_param_grads[0]);
    train_outs.push_back(fc8->f_param_grads[1]);
    train_outs.push_back(fc7->f_param_grads[0]);
    train_outs.push_back(fc7->f_param_grads[1]);
    train_outs.push_back(fc6->f_param_grads[0]);
    train_outs.push_back(fc6->f_param_grads[1]);
    train_outs.push_back(conv5_3 ->f_param_grads[0]);
    train_outs.push_back(conv5_3->f_param_grads[1]);
    train_outs.push_back(conv5_2->f_param_grads[0]);
    train_outs.push_back(conv5_2->f_param_grads[1]);
    train_outs.push_back(conv5_1->f_param_grads[0]);
    train_outs.push_back(conv5_1->f_param_grads[1]);
    train_outs.push_back(conv4_3->f_param_grads[0]);
    train_outs.push_back(conv4_3->f_param_grads[1]);
    train_outs.push_back(conv4_2->f_param_grads[0]);
    train_outs.push_back(conv4_2->f_param_grads[1]);
    train_outs.push_back(conv4_1->f_param_grads[0]);
    train_outs.push_back(conv4_1->f_param_grads[1]);
    train_outs.push_back(conv3_3->f_param_grads[0]);
    train_outs.push_back(conv3_3->f_param_grads[1]);
    train_outs.push_back(conv3_2->f_param_grads[0]);
    train_outs.push_back(conv3_2->f_param_grads[1]);
    train_outs.push_back(conv3_1->f_param_grads[0]);
    train_outs.push_back(conv3_1->f_param_grads[1]);
    train_outs.push_back(conv2_2->f_param_grads[0]);
    train_outs.push_back(conv2_2->f_param_grads[1]);
    train_outs.push_back(conv2_1->f_param_grads[0]);
    train_outs.push_back(conv2_1->f_param_grads[1]);
    train_outs.push_back(conv1_2->f_param_grads[0]);
    train_outs.push_back(conv1_2->f_param_grads[1]);
    train_outs.push_back(conv1_1->f_param_grads[0]);
    train_outs.push_back(conv1_1->f_param_grads[1]);
    ...
    string train_path="/Users/tianjunz/Desktop/llvm5.0/halide_build/code/Halide-NN/dataloaders/cifar10_train_lmdb";
    string test_path="/Users/tianjunz/Desktop/llvm5.0/halide_build/code/Halide-NN/dataloaders/cifar10_test_lmdb";
    ...
    // Training 
    int num_iterartions = 1000;
    float lr = 1e-5; 
    float momentum = 0.9;

    // Initialize the biases in the network
    init_constant(fc8->params[1], 0.0);
    init_constant(fc7->params[1], 0.0);
    init_constant(fc6->params[1], 0.0);
    init_constant(conv5_3->params[1], 0.0);
    init_constant(conv5_2->params[1], 0.0);
    init_constant(conv5_1->params[1], 0.0);
    init_constant(conv4_3->params[1], 0.0);
    init_constant(conv4_2->params[1], 0.0);
    init_constant(conv4_1->params[1], 0.0);
    init_constant(conv3_3->params[1], 0.0);
    init_constant(conv3_2->params[1], 0.0);
    init_constant(conv3_1->params[1], 0.0);
    init_constant(conv2_2->params[1], 0.0);
    init_constant(conv2_1->params[1], 0.0);
    init_constant(conv1_2->params[1], 0.0);
    init_constant(conv1_1->params[1], 0.0);

    // Initialize weights in the network
    init_gaussian(fc8->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(fc7->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(fc6->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv5_3->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv5_2->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv5_1->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv4_3->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv4_2->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv4_1->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv3_3->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv3_2->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv3_1->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv2_2->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv2_1->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv1_2->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv1_1->params[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);

    // Initialize the biases in the network
    init_constant(fc8->params_cache[1], 0.0);
    init_constant(fc7->params_cache[1], 0.0);
    init_constant(fc6->params_cache[1], 0.0);
    init_constant(conv5_3->params_cache[1], 0.0);
    init_constant(conv5_2->params_cache[1], 0.0);
    init_constant(conv5_1->params_cache[1], 0.0);
    init_constant(conv4_3->params_cache[1], 0.0);
    init_constant(conv4_2->params_cache[1], 0.0);
    init_constant(conv4_1->params_cache[1], 0.0);
    init_constant(conv3_3->params_cache[1], 0.0);
    init_constant(conv3_2->params_cache[1], 0.0);
    init_constant(conv3_1->params_cache[1], 0.0);
    init_constant(conv2_2->params_cache[1], 0.0);
    init_constant(conv2_1->params_cache[1], 0.0);
    init_constant(conv1_2->params_cache[1], 0.0);
    init_constant(conv1_1->params_cache[1], 0.0);

    // Initialize weights in the network
    init_gaussian(fc8->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(fc7->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(fc6->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv5_3->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv5_2->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv5_1->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv4_3->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv4_2->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv4_1->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv3_3->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv3_2->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv3_1->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv2_2->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv2_1->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv1_2->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    init_gaussian(conv1_1->params_cache[0], 0.0001 * 0.0, 0.0001 * 1.0, rd);
    ...
    /*for (int it = 0; it < num_iterartions; it++) {
        ...
        timeval t1, t2;
        gettimeofday(&t1, NULL);
        train.realize({loss, scores, fc8->param_grads[0], fc8->param_grads[1], fc7->param_grads[0], fc7->param_grads[1], 
                       fc6->param_grads[0], fc6->param_grads[1], conv5_3->param_grads[0], conv5_3->param_grads[1], conv5_2->param_grads[0], 
                       conv5_2->param_grads[1], conv5_1->param_grads[0], conv5_1->param_grads[1], 
                       conv4_3->param_grads[0], conv4_3->param_grads[1], conv4_2->param_grads[0], 
                       conv4_2->param_grads[1], conv4_1->param_grads[0], conv4_1->param_grads[1],
                       conv3_3->param_grads[0], conv3_3->param_grads[1], conv3_2->param_grads[0], 
                       conv3_2->param_grads[1], conv3_1->param_grads[0], conv3_1->param_grads[1],
                       conv2_2->param_grads[0], conv2_2->param_grads[1], conv2_1->param_grads[0], conv2_1->param_grads[1],
                       conv1_2->param_grads[0], conv1_2->param_grads[1], conv1_1->param_grads[0], conv1_1->param_grads[1]});
